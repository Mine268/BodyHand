...
namespace BodyHand {
        ...
        std_{ 0.229f, 0.224f, 0.225f }
    {
        ...
        sess_opts_.AppendExecutionProvider_CUDA(cudaOption);

		std::wstring pose_model_w(pose_model.begin(), pose_model.end());
        sess_ = Ort::Session(env_, pose_model_w.c_str(), sess_opts_);
